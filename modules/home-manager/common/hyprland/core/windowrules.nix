  ...
  wayland.windowManager.hyprland = {
    settings.windowrule = [
...

      {
        name = "Terminals";
        "match:class" =
          "^(com.mitchellh.ghostty|org.wezfurlong.wezterm|Alacritty|kitty|kitty-dropterm|dropterminal)$";
        tag = "+terminal";
      }
...

      {
        name = "qs-keybinds";
        "match:title" =
          "^(Hyprland Keybinds|Emacs Leader Keybinds|Kitty Configuration|WezTerm Configuration|Ghostty Configuration|Yazi Configuration)$";
        float = "on";
        center = "on";
        size = "55% = 66%";
      }
...

      {
        ...
        "match:title" =
          "^(Hyprland Keybinds|Niri Keybinds|BSPWM Keybinds|i3 Keybinds|Sway Keybinds|DWM Keybinds|Emacs Leader Keybinds|Kitty Configuration|WezTerm Configuration|Ghostty Configuration|Yazi Configuration|Cheatsheets Viewer|Documentation Viewer)$";
        float = "on";
        center = "on";
        size = "55% = 66%";
      }
